...
<head>
    ...
    <meta name="description" content="Halaman Login E-Jurnal Guru - SD Negeri 01 Poros Data.">
    <title>Login E-Jurnal Guru - SD Negeri 01 Poros Data</title>
...
<body class="min-h-screen text-slate-900 dark:text-slate-100 antialiased transition-colors duration-300 flex items-center justify-center p-4 relative bg-slate-50 dark:bg-slate-950">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none -z-20">
        <!-- Subtle gradient and decorative blur circles to match PorosData -->
    ...
    <div class="w-full max-w-md relative">
        <div class="glass-panel border border-slate-200/80 dark:border-slate-800/80 shadow-2xl rounded-3xl p-8 sm:p-10 transition-all duration-300">
            ...
            <div class="flex flex-col items-center mb-6">
                <div class="h-16 w-16 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-500 flex items-center justify-center text-white font-bold shadow-md shadow-blue-200 dark:shadow-none mb-4">
                ...
                <h1 class="text-2xl font-extrabold tracking-tight text-center text-blue-600 dark:text-blue-400">
            ...
            <form action="{{ url('/porosdata/e-journal/login') }}" method="POST" class="space-y-5">
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full flex items-center justify-center gap-2 mt-2 px-5 py-3 text-sm font-semibold rounded-2xl bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-500/15 dark:shadow-none hover:shadow-xl hover:shadow-blue-500/25 active:scale-[0.98] transition-all focus:outline-none focus:ring-4 focus:ring-blue-500/25">
                    Masuk
                </button>
            </form>
        </div>
