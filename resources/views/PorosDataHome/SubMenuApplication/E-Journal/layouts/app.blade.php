...
<body class="min-h-full bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 antialiased transition-colors duration-300">
    ...
    <!-- Toast Notifications -->
    @if (session('success'))
        <div id="toast" class="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-xl border glass-panel border-emerald-100 dark:border-emerald-950/30 transition-all duration-300 translate-y-12 opacity-0">
