...
<div class="max-w-5xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Daftar guru aktif di lingkungan sekolah. Pengelolaan data guru hanya dapat dilakukan melalui portal utama PorosData.
        </p>
    </div>
    ...
    <div class="mb-6 p-4 rounded-2xl bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30 flex items-start gap-3">
        ...
        <div>
            ...
            <span class="block text-xs text-amber-650 dark:text-amber-455 mt-0.5">Data guru tersinkronisasi langsung dari database PorosData. Hubungi administrator utama untuk melakukan perubahan data.</span>
        </div>
    </div>
