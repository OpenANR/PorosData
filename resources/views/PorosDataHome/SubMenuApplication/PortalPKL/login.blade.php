...
<head>
    ...
    <meta name="description" content="Halaman Login Portal PKL - Poros Data.">
    <title>Login - Portal PKL - Poros Data</title>
            ...
            <div class="relative z-10 mt-auto pt-8">
                <div class="bg-white/10 dark:bg-slate-950/40 backdrop-blur-md border border-white/15 rounded-2xl p-5 shadow-xl">
                    ...
                    <p class="text-xs sm:text-sm text-slate-200 leading-relaxed font-normal">
                        "Portal PKL memfasilitasi pengelolaan program Praktik Kerja Lapangan, mulai dari pendaftaran, penempatan, hingga pemantauan kegiatan siswa di dunia industri."
                    </p>
                </div>
            </div>
        </div>
