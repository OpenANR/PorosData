...
@section('content')
    ...
    <div class="mb-8 p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 shadow-sm">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h3 class="text-base font-bold text-slate-900 dark:text-white">Modul Riwayat DO Siswa</h3>
    ...
    <!-- Header Section -->
    <div class="mb-6">
        <h1 class="text-2xl font-extrabold tracking-tight text-slate-950 dark:text-white">Riwayat DO Siswa</h1>
