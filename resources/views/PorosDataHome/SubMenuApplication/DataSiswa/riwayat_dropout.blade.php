...
@section('content')
    ...
    <div class="mb-6">
        ...
        <p class="text-slate-400 dark:text-slate-500 text-xs font-semibold mt-0.5">{{ $sd ? $sd->nama_sekolah : 'Sekolah SD' }} — Catatan historis siswa yang tidak aktif atau dropout</p>
    </div>
