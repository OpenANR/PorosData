...
@section('title', 'Input Nilai Guru - Portal Nilai')
...
<div class="flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            <div id="info-pg-detail" class="space-y-2">
                ...
                <ul class="list-disc list-inside pl-3.5 space-y-1 text-[10px] text-slate-500 dark:text-slate-400">
                    <li>Ketik nomor soal yang <strong class="text-blue-600 dark:text-blue-400">Benar</strong> or <strong class="text-blue-600 dark:text-blue-400">Salah</strong> dipisahkan dengan koma (contoh: <code>1,2,5,7</code>).</li>
    ...
    <div id="table-container" class="hidden flex-col flex-grow bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 rounded-2xl overflow-hidden shadow-sm animate-fade-in">
        ...
        <div class="bg-slate-50 dark:bg-slate-950 border-t border-slate-200/60 dark:border-slate-800/60 p-4 flex justify-end sticky left-0 bottom-0 z-30 shadow-inner shrink-0">
